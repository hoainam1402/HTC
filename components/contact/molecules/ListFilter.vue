      ...
      <v-expansion-panel-content>
        <v-row class="align-center" dense>
          <v-col cols="12" sm="6" md="3">
            <select-contact-type v-model="filter.type" :label="$t('contact.model.types')" :outlined="false" />
          </v-col>
          <v-col cols="12" sm="6" md="3">
...
import SelectContactType from '~/components/contact/organisms/SelectContactType'
